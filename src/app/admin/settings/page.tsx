          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Booking.com direct affiliate (aid param). Register at <a href="https://www.booking.com/affiliate-program/v2/index.html" target="_blank" rel="noopener noreferrer" className="text-[#004D98] hover:underline">booking.com/affiliate-program</a></p>
              </div>
