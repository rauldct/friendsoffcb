...
const ALLOWED_KEYS = ["ANTHROPIC_API_KEY", "GA_MEASUREMENT_ID", "API_FOOTBALL_KEY", "RESEND_API_KEY", "PERPLEXITY_API_KEY", "GROK_API_KEY", "FOOTBALL_DATA_API_KEY", "GOOGLE_API_KEY", "GOOGLE_SEARCH_CX"];
